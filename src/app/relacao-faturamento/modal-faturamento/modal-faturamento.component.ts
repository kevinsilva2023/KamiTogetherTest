...
@Component({
  selector: 'app-modal-faturamento',
  templateUrl: './modal-faturamento.component.html',
  styleUrls: ['./modal-faturamento.component.scss']
})
export class ModalFaturamentoComponent {
  faturamentos = [
    {
      mesAno: '08/2023',
